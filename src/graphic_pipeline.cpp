...
void createGraphicsPipeline()
{
    ...
    pipelineLayoutInfo.setLayoutCount = 1; // 这里改为 1
    // pipelineLayoutInfo.pushConstantRangeCount = 0;    // Optional
    // pipelineLayoutInfo.pPushConstantRanges = nullptr; // Optional
    // pipelineLayoutInfo.pushConstantRangeCount = 0; // 注释掉这句
    pipelineLayoutInfo.pSetLayouts = &descriptorSetLayout; // 在这里指定描述符
