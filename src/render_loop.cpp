...
void createSyncObjects()
{
    ...
    /*
        以下的设置意味着在创建fences时就发出一个“signaled”信号，从而使得第一次询问fence总是通过。这在我们的
    程序中避免了首次询问“上一帧图像是否渲染完成”造成阻塞的问题（因为对于第一帧图像不可能有“上一帧”这个概念）
    */
